 ...
 */
final class Version20240903072914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD color1 VARCHAR(255) DEFAULT NULL, ADD color2 VARCHAR(255) DEFAULT NULL, ADD color3 VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE achieve_items CHANGE player_id player_id INT DEFAULT NULL, CHANGE season_id season_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE amplua CHANGE id id INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE city CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE country_id country_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE country CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE translit translit VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE cupplayer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ecplayer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL, CHANGE turnir_id turnir_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ectable CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE stadia_id stadia_id INT DEFAULT NULL, CHANGE turnir_id turnir_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE fnlplayer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE game DROP FOREIGN KEY FK_232B318C3721E7B1');
        $this->addSql('ALTER TABLE game CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE team2_id team2_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL, CHANGE player2_id player2_id INT DEFAULT NULL, CHANGE city_id city_id INT DEFAULT NULL, CHANGE referee_id referee_id INT DEFAULT NULL, CHANGE turnir_id turnir_id INT DEFAULT NULL, CHANGE stadia_id stadia_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE gamers CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL, CHANGE totalgame totalgame INT DEFAULT 0 NOT NULL, CHANGE totalgoal totalgoal INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE lchplayer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mundial CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE country_id country_id INT DEFAULT NULL, CHANGE country2_id country2_id INT DEFAULT NULL, CHANGE turnir_id turnir_id INT DEFAULT NULL, CHANGE stadia_id stadia_id INT DEFAULT NULL, CHANGE city_id city_id INT DEFAULT NULL, CHANGE referee_id referee_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE mundial_table CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE turnir_id turnir_id INT NOT NULL, CHANGE country_id country_id INT NOT NULL, CHANGE stadia_id stadia_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE nfl_match CHANGE team_id team_id INT DEFAULT NULL, CHANGE team2_id team2_id INT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE nhl_conf CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE name name VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`');
        $this->addSql('ALTER TABLE nhl_division CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE conf_id conf_id INT NOT NULL, CHANGE name name VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`');
        $this->addSql('ALTER TABLE nhl_division RENAME INDEX idx_43a4fc207fdf4958 TO conf');
        $this->addSql('ALTER TABLE nhl_match DROP FOREIGN KEY FK_7C115B3D296CD8AE');
        $this->addSql('ALTER TABLE nhl_match DROP FOREIGN KEY FK_7C115B3DF59E604A');
        $this->addSql('ALTER TABLE nhl_match DROP FOREIGN KEY FK_7C115B3D3721E7B1');
        $this->addSql('ALTER TABLE nhl_match CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT NOT NULL, CHANGE team_id team_id INT NOT NULL, CHANGE team2_id team2_id INT NOT NULL, CHANGE stadia_id stadia_id INT NOT NULL, CHANGE bomb bomb VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`, CHANGE overtime overtime TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE nhl_players_team CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE player_id player_id INT NOT NULL, CHANGE team_id team_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE nhl_reg CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT NOT NULL, CHANGE team_id team_id INT NOT NULL, CHANGE player_id player_id INT NOT NULL, CHANGE goal goal INT DEFAULT 0 NOT NULL, CHANGE assist assist INT DEFAULT 0 NOT NULL, CHANGE score score INT DEFAULT 0 NOT NULL, CHANGE game game INT DEFAULT 0 NOT NULL, CHANGE missed missed INT DEFAULT 0 NOT NULL, CHANGE zero zero INT DEFAULT 0 NOT NULL, CHANGE game_play_off game_play_off INT DEFAULT 0 NOT NULL, CHANGE game_sum game_sum INT DEFAULT 0 NOT NULL, CHANGE goal_play_off goal_play_off INT DEFAULT 0 NOT NULL, CHANGE goal_sum goal_sum INT DEFAULT 0 NOT NULL, CHANGE assist_play_off assist_play_off INT DEFAULT 0 NOT NULL, CHANGE assist_sum assist_sum INT DEFAULT 0 NOT NULL, CHANGE score_play_off score_play_off INT DEFAULT 0 NOT NULL, CHANGE score_sum score_sum INT DEFAULT 0 NOT NULL, CHANGE missed_play_off missed_play_off INT DEFAULT 0 NOT NULL, CHANGE missed_sum missed_sum INT DEFAULT 0 NOT NULL, CHANGE zero_play_off zero_play_off INT DEFAULT 0 NOT NULL, CHANGE zero_sum zero_sum INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE nhl_stadia CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE name name VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`, CHANGE translit translit VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`');
        $this->addSql('ALTER TABLE nhl_table CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT NOT NULL, CHANGE team_id team_id INT NOT NULL, CHANGE division_id division_id INT NOT NULL, CHANGE mz mz INT DEFAULT 0 NOT NULL, CHANGE mp mp INT DEFAULT 0 NOT NULL, CHANGE score score INT DEFAULT 0 NOT NULL, CHANGE winst winst INT DEFAULT 0, CHANGE porazht porazht INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE player CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE amplua_id amplua_id INT DEFAULT NULL, CHANGE country_id country_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE insertdate insertdate DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE sbornie sbornie INT DEFAULT NULL, CHANGE viewed viewed INT DEFAULT 0 NOT NULL');
        $this->addSql('CREATE INDEX born ON player (born)');
        $this->addSql('CREATE INDEX name ON player (name)');
        $this->addSql('ALTER TABLE playersteam CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE referee CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE country_id country_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rusplayer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE player_id player_id INT DEFAULT NULL, CHANGE ecgame ecgame INT DEFAULT 0 NOT NULL, CHANGE ecgoal ecgoal INT DEFAULT 0 NOT NULL, CHANGE cupgame cupgame INT DEFAULT 0 NOT NULL, CHANGE cupgoal cupgoal INT DEFAULT 0 NOT NULL, CHANGE supercupgame supercupgame INT DEFAULT 0 NOT NULL, CHANGE supercupgoal supercupgoal INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE sbplayer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE seasons CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE lastdate lastdate DATETIME DEFAULT NULL, CHANGE last_id last_id INT DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX name ON seasons (name)');
        $this->addSql('ALTER TABLE shipplayer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL, CHANGE game game INT DEFAULT 0 NOT NULL, CHANGE sbornie sbornie INT DEFAULT NULL');
        $this->addSql('CREATE INDEX team_id ON shipplayer (team_id, season_id)');
        $this->addSql('ALTER TABLE shiptable CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE country_id country_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sostav CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE season_id season_id INT DEFAULT NULL, CHANGE country_id country_id INT DEFAULT NULL, CHANGE team_id team_id INT DEFAULT NULL, CHANGE player_id player_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE team DROP color1, DROP color2, DROP color3, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE country_id country_id INT DEFAULT NULL, CHANGE city_id city_id INT DEFAULT NULL, CHANGE game game INT DEFAULT 0 NOT NULL, CHANGE wins wins INT DEFAULT 0 NOT NULL, CHANGE nich nich INT DEFAULT 0 NOT NULL, CHANGE porazh porazh INT DEFAULT 0 NOT NULL, CHANGE mz mz INT DEFAULT 0 NOT NULL, CHANGE mp mp INT DEFAULT 0 NOT NULL, CHANGE score score INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE transfer CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE old_id old_id INT NOT NULL, CHANGE new_id new_id INT NOT NULL, CHANGE period_id period_id INT NOT NULL');
        $this->addSql('ALTER TABLE turnir CHANGE id id INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE user DROP INDEX UNIQ_8D93D649F85E0677, ADD INDEX username (username)');
        $this->addSql('ALTER TABLE user CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE roles roles JSON DEFAULT NULL, CHANGE is_verified is_verified TINYINT(1) DEFAULT NULL');
    }
}
