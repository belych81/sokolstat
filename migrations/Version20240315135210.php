 ...
 */
final class Version20240315135210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seasons ADD lastdate DATETIME NULL, ADD last_id INT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nhl_match CHANGE season_id season_id INT NOT NULL, CHANGE team_id team_id INT NOT NULL, CHANGE stadia_id stadia_id INT NOT NULL, CHANGE bomb bomb VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`, CHANGE overtime overtime TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE nhl_table CHANGE season_id season_id INT NOT NULL, CHANGE team_id team_id INT NOT NULL, CHANGE division_id division_id INT NOT NULL, CHANGE mz mz INT DEFAULT 0 NOT NULL, CHANGE mp mp INT DEFAULT 0 NOT NULL, CHANGE score score INT DEFAULT 0 NOT NULL, CHANGE winst winst INT DEFAULT 0, CHANGE porazht porazht INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE seasons DROP lastdate, DROP last_id');
