...
/**
 * @ORM\Entity(repositoryClass="App\Repository\EctableRepository")
 */
class Ectable
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Seasons", inversedBy="ectables")
     * @ORM\JoinColumn(nullable=false)
     */
    private $season;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Team", inversedBy="ectables")
     * @ORM\JoinColumn(nullable=false)
     */
    private $team;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Stadia", inversedBy="ectables")
     * @ORM\JoinColumn(nullable=false)
     */
    private $stadia;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Turnir", inversedBy="ectables")
     * @ORM\JoinColumn(nullable=false)
     */
    private $turnir;
